...
#if defined(CONFIG_MACH_URSA)
	CLK_LOOKUP("cam_src_clk", mmss_gp0_clk_src.c, "6c.qcom,camera"), //FFC	2345
	CLK_LOOKUP("cam_clk", camss_gp0_clk.c, "6c.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "6a.lab126,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk1_clk.c, "6a.lab126,camera"),
#else

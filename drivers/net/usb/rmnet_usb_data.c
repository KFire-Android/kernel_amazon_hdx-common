...
#define PID9003_IFACE_MASK	0xFF
#define PID9004_IFACE_MASK	0xFF
...
static const struct driver_info rmnet_info_ernie = {
	.description   = "RmNET net device",
	.flags         = FLAG_SEND_ZLP,
	.bind          = rmnet_usb_bind,
	.tx_fixup      = rmnet_usb_tx_fixup,
	.rx_fixup      = rmnet_usb_rx_fixup,
	.manage_power  = rmnet_usb_manage_power,
	.data          = PID9003_IFACE_MASK,
};

static const struct driver_info rmnet_info_ernie2 = {
	.description   = "RmNET net device",
	.flags         = FLAG_SEND_ZLP,
	.bind          = rmnet_usb_bind,
	.tx_fixup      = rmnet_usb_tx_fixup,

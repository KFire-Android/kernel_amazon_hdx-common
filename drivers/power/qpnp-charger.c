...
/* URSA: latest charger_monitor requires lower Vinmin. */
/* The settings are in other QC branches not not updated in 3.4. */
/* This comment can be removed once QC is in sync. */

...
#define MMC_QUIRK_INAND_DATA_TIMEOUT  (1<<8)    /* For incorrect data timeout */
	...
	enum mmc_disk_encryption_state	encryption_state;
#define MMC_MAX_CRYPTO_INFO_SIZE 256
	/* Range of sectors to be encrypted */
	char			crypto_info[MMC_MAX_CRYPTO_INFO_SIZE];

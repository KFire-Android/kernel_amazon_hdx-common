...
enum rmnet_ioctl_cmds_e {
	...
	RMNET_IOCTL_PM_ENABLE	     = 0x000089FC, /* PM runtime enable	     */
	RMNET_IOCTL_PM_DISABLE	     = 0x000089FD, /* PM runtime disable     */
	RMNET_IOCTL_PM_WAKE_ENABLE   = 0x000089FE, /* Remote wakeup enable   */
	RMNET_IOCTL_PM_WAKE_DISABLE  = 0x000089FF, /* Remote wakeup disable  */
	RMNET_IOCTL_MAX
};

...
enum msm_camera_ois_config_t {
	MSM_CAMERA_OIS_POWER_UP,
	MSM_CAMERA_OIS_POWER_DOWN,
	MSM_CAMERA_OIS_ENABLE,
	MSM_CAMERA_OIS_DISABLE,
};

struct msm_camera_ois_cfg_t {
	enum msm_camera_ois_config_t cfgtype;
};

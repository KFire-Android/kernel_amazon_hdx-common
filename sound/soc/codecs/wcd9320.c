...
static const unsigned int digital_gain_range[] = {
	TLV_DB_RANGE_HEAD(1),
	0, 123, TLV_DB_SCALE_ITEM(-8400, 100, 0),
};
#endif
...
static const struct wcd9xxx_reg_mask_val taiko_codec_reg_init_val[] = {
	...
	{TAIKO_A_CDC_TX10_MUX_CTL, 0x8, 0x0},
       ...
       /* config Decimator for DMIC CLK_MODE_1(2.4Mhz@9.6Mhz mclk) */
       {TAIKO_A_CDC_TX1_DMIC_CTL, 0x7, 0x2},
       {TAIKO_A_CDC_TX2_DMIC_CTL, 0x7, 0x2},
       {TAIKO_A_CDC_TX3_DMIC_CTL, 0x7, 0x2},
       {TAIKO_A_CDC_TX4_DMIC_CTL, 0x7, 0x2},
       {TAIKO_A_CDC_TX5_DMIC_CTL, 0x7, 0x2},
       {TAIKO_A_CDC_TX6_DMIC_CTL, 0x7, 0x2},
       {TAIKO_A_CDC_TX7_DMIC_CTL, 0x7, 0x2},
       {TAIKO_A_CDC_TX8_DMIC_CTL, 0x7, 0x2},
       {TAIKO_A_CDC_TX9_DMIC_CTL, 0x7, 0x2},
       {TAIKO_A_CDC_TX10_DMIC_CTL, 0x7, 0x2},

       /* config DMIC clk to CLK_MODE_1 (2.4Mhz@9.6Mhz mclk) */
       {TAIKO_A_CDC_CLK_DMIC_B1_CTL, 0xEE, 0x44},
       {TAIKO_A_CDC_CLK_DMIC_B2_CTL, 0x0E, 0x04},
